...
mod floor;
mod is_equal_type;
mod is_equal_type_all;
mod is_equal_type_any;
...
impl LintRunner<LintData> for Runner {
    ...
    fn run(
        ...
        codes.extend(is_equal_type::check(target, processed, config));
        codes.extend(is_equal_type_all::check(target, processed, config));
        codes.extend(is_equal_type_any::check(target, processed, config));
